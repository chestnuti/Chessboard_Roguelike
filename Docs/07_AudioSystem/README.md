...
| 文档 | 说明 |
| --- | --- |
| [Audio_SystemGuide.md](Audio_SystemGuide.md) | 音频系统技术说明，覆盖 `UGameAudioSubsystem`、音频 DataAsset、随机音效池、BGM 淡入淡出、BGM/SFX 音量控制、玩家/敌人/关卡/UI 音效触发点和配置流程。 |
...
- [UI 菜单系统](../08_UIMenus/README.md)：Setting 菜单通过 BGM/SFX 滑条调用音频系统音量接口。
