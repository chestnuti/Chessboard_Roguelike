...
本模块记录玩家近战攻击、敌人属性、免疫与阈值击杀、敌人对玩家造成伤害、敌人跨阵营友伤、敌方行动调度、敌人管理器、战斗相机和战斗预览系统。
...
| [CombatPreview_SystemGuide.md](CombatPreview_SystemGuide.md) | Combat Preview 技术说明，覆盖可击杀预览、玩家受威胁预览、`FCombatPreviewState`、`ICombatPreviewReceiver`、敌人材质/Widget 接口事件和变身悬停风险预览。 |
...
- [变身棋子系统](../06_TransformSystem/README.md)：变身捕获目标会复用 Combat Preview 显示可击杀和落点风险。
